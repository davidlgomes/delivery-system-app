...
describe 'Usuario vê frota de veículo de uma transportadora' do
    ...
    it 'com sucesso' do
        ...
        primeiro_veiculo = VehicleDelivery.create!(vehicle_plate: 'LDU-2009' ,brand_vehicle: 'Chevrolet' , model_vehicle: 'Corsa' ,
                                                  year_of_manucfature: '2007' , maximum_load_capacity: '300', 
                                                  carrier_management: primeiro_carrier_management)
        segundo_veiculo = VehicleDelivery.create!(vehicle_plate: 'LDU-2010' ,brand_vehicle: 'FIAT' , model_vehicle: 'UNO' ,
                                                year_of_manucfature: '2009' , maximum_load_capacity: '400', 
                                                carrier_management: primeiro_carrier_management)
        visit root_path
        click_on 'Veículo'
